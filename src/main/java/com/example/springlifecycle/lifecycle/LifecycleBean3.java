...
public class LifecycleBean3 implements BeanNameAware, ApplicationContextAware,
        InitializingBean, DisposableBean, BeanFactoryAware {
    Logger logger = Logger.getLogger(LifecycleBean3.class.getName());
    ...
    public void setName(String name) {
        this.name = name;
        logger.info("LifecycleBean3.setNameProperty");
    }
    ...
    public void preDestroy() {
        System.out.println("06 LifecycleBean3.preDestroy");
    }

    @Override
    public void destroy() throws Exception {
        System.out.println("06 LifecycleBean3.destroy");
    }

    public void destroyMethod() {
        System.out.println("06 LifecycleBean3.destroyMethod");
    }
